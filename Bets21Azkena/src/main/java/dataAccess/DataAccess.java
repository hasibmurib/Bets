...
public class DataAccess {
	...
	public List<ErrepikatuakContainer> getErrepikatzaileak(Bezeroa bezeroa) {
		List<ErrepikatuakContainer> emaitza = new ArrayList<ErrepikatuakContainer>();
		Bezeroa erabiltzailea = db.find(Bezeroa.class, bezeroa.getErabiltzaileIzena());
	...
	public List<ErrepikatuakContainer> getErrepikapenak(Bezeroa bezeroa) {
