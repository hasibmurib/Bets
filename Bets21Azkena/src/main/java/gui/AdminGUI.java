...
public class AdminGUI extends JFrame {
	...
	public void AdminGUIExekuzioa() throws Exception{
		this.setTitle(ResourceBundle.getBundle(tags).getString("Admin")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		JLabel lblNewLabel = new JLabel(ResourceBundle.getBundle(tags).getString("Welcome")+" "+admin.getErabiltzaileIzena()+"!"); //$NON-NLS-1$ //$NON-NLS-2$
		lblNewLabel.setBounds(124, 23, 250, 29);
		contentPane.add(lblNewLabel);
		
		JButton btnNewButton = new JButton(ResourceBundle.getBundle(tags).getString("SignOut"));
		...
		btnCreateQuestion.setText(ResourceBundle.getBundle(tags).getString("CreateQuestion")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		eguneratuHilabetekoak.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				done.setText(ResourceBundle.getBundle(tags).getString("Done"));
			}
		});
		eguneratuHilabetekoak.setText(ResourceBundle.getBundle(tags).getString("ResetMonth")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		puntuazioakIkusi.setText(ResourceBundle.getBundle(tags).getString("ViewWorker")); //$NON-NLS-1$ //$NON-NLS-2$
